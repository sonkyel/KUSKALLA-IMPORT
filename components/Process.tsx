  ...
  return (
    <section id="proceso" className="bg-charcoal py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3">
          {steps.map((s, i) => (
            <Reveal key={s.n} delay={i * 0.08}>
              <div className="h-full border border-white/10 bg-charcoal-2 p-7">
        ...
        {/* Banda de envíos */}
        <Reveal delay={0.1}>
          <div className="mt-8 flex flex-col items-center justify-between gap-5 border border-accent/30 bg-accent/5 p-7 md:flex-row">
